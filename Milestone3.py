...
class CWMachine(StateMachine):
    ...
    def on_enter_dot(self):
        ...
        ## complete.
        self.redLight.blink(on_time=0.5, off_time=0, n=1, background=False)  # Blink red light for 500ms
    ...
    def on_enter_dash(self):
        ...
        ## complete.
        self.blueLight.blink(on_time=1.5, off_time=0, n=1, background=False)  # Blink blue light for 1500ms
